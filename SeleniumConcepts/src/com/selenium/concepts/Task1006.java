...
public static void main(String[] args) throws InterruptedException {
	...
	WebElement Alertbo = driver.findElement(By.xpath("(//button[contains(@onclick,'if ')])[2]"));
	Alertbo.click();
	Alert alert2 = driver.switchTo().alert();
	alert2.accept();
	Thread.sleep(2000);
	
	WebElement Confirm = driver.findElement(By.xpath("(//button[contains(@onclick,'if ')])[3]"));
	Confirm.click();
